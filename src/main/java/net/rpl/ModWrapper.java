...
public class ModWrapper {
	...
	public ModWrapper(Object instance) {
		...
		this.id = instance.getClass().getAnnotation(Mod.class).id();
		this.name = instance.getClass().getAnnotation(Mod.class).name();
		this.version = instance.getClass().getAnnotation(Mod.class).version();
